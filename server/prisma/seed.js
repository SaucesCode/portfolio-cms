    ...
    data: [
      {
        ...
        description:
          "A full-stack shopping platform with cart, checkout, and admin dashboard.",
        techStack: ["React", "Node.js", "PostgreSQL", "Stripe"],
        liveUrl: "https://example.com",
        githubUrl: "https://github.com",
        githubRepoName: "ecommerce-platform",
        stars: 42,
        forks: 8,
        language: "JavaScript",
        featured: true,
      ...
      {
        title: "AI Chat App",
        description: "Real-time chat application with AI-powered smart replies.",
        techStack: ["React", "Socket.io", "OpenAI", "Express"],
        liveUrl: "https://example.com",
        githubUrl: "https://github.com",
        githubRepoName: "ai-chat-app",
        stars: 28,
        forks: 5,
        language: "TypeScript",
        featured: true,
      ...
      },
      {
        ...
        description: "A drag-and-drop portfolio builder for developers.",
